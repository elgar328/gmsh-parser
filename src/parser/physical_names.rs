...
pub fn parse<R: std::io::Read>(
    ...
    for _ in 0..num_physical_names {
        ...
        let physical_tag: i32 = parts[1].parse()?;
        ...
        mesh.physical_names.insert((dimension, physical_tag), name);
    }
...
"#;
        ...
        assert_eq!(mesh.physical_name(2, 1), Some("Surface"));
        assert_eq!(mesh.physical_name(3, 2), Some("Volume"));
    }
